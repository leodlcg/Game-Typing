class Inimigo{
    ...
    animarMorte(){
        document.getElementById("imgInimigo").style.backgroundImage = `url(imgs/inimigos/${this.dificuldade}/${this.inimigo}/Derrotado/Base.png)`;
        document.getElementById("imgInimigo").style.backgroundImage = `url(imgs/inimigos/${this.dificuldade}/${this.inimigo}/Derrotado/Animacao.gif)`;
    ...
    animarAtaque(){
        if (this.Animacao === true) return;  
        this.Animacao = true;
        document.getElementById("imgInimigo").style.backgroundImage = `url(imgs/inimigos/${this.dificuldade}/${this.inimigo}/Atacando/Animacao.gif)`;
        setTimeout(() => {
            this.Animacao = false;
        }, 1000);
    }
